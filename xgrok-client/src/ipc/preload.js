...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    hiddenWindow:(data)=>ipcRenderer.invoke('xgrok',{type:'hiddenWindow', data:data}),
    closeWindow:(data)=>ipcRenderer.invoke('xgrok',{type:'closeWindow', data:data}),
    openExternal:(data)=>ipcRenderer.invoke('xgrok',{type:'openExternal', data:data}),
    getSystemInfo:(data)=>ipcRenderer.invoke('system',{type:'getSystemInfo', data:data}),
    checkPort:(data)=>ipcRenderer.invoke('system',{type:'checkPort', data:data}),
    ...
    setAutoLauncher:(data)=>ipcRenderer.invoke('system',{type:'setAutoLauncher', data:data}),
    getAutoLauncher:()=>ipcRenderer.invoke('system',{type:'getAutoLauncher'}),
