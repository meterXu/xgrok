...
@swaggerClass() export default class EmailModel {
    constructor(body) {
    ...
    @swaggerProperty({type: "string", description: "", nullable: true}) email
    @swaggerProperty({type: "string", description: "", nullable: true}) code
